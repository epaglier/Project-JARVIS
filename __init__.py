...
class GoogleCalendarSkill(MycroftSkill):
	...
	self.maxResults = 10
	self.gmt = '-06:00'
	self.timeZone = 'America/El_Salvador'
	self.attendees_own = 'xxxxx1@gmail.com, xxxxx2@gmail.com'
	self.attendees_family = 'xxxxx3@gmail.com, xxxxx3@gmail.com'
	self.attendees_work = 'support.mywork@gmail.com,sales.mywork@gmail.com,info.mywork@icloud.com'
	self.reminders_email = 1440
	self.reminders_popup = 10
	self.default_duration = 2
	self.time_format = 12
